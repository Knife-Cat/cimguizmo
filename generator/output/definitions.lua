local t={
  ...
  ImGuizmo_SetID={
    [1]={
      ...
      stname=""},
    ["(int)"]=nil},
  ImGuizmo_SetImGuiAssert={
    [1]={
      args="(ImAssertFunc ctx)",
      argsT={
        [1]={
          name="ctx",
          type="ImAssertFunc"}},
      argsoriginal="(ImAssertFunc ctx)",
      call_args="(ctx)",
      cimguiname="ImGuizmo_SetImGuiAssert",
      defaults={},
      funcname="SetImGuiAssert",
      location="ImGuizmo:134",
      namespace="ImGuizmo",
      ov_cimguiname="ImGuizmo_SetImGuiAssert",
      ret="void",
...
t.ImGuizmo_SetImGuiAssert["(ImAssertFunc)"]=t.ImGuizmo_SetImGuiAssert[1]
